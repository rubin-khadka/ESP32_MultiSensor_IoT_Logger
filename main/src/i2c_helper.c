...
esp_err_t I2C_Read_Reg(i2c_port_t bus, uint8_t dev_addr, uint8_t reg_addr,
					   uint8_t *data) {
...
esp_err_t I2C_Write_Reg(i2c_port_t bus, uint8_t dev_addr, uint8_t reg_addr,
						uint8_t data) {
	i2c_cmd_handle_t cmd = i2c_cmd_link_create();
...
esp_err_t I2C_Read_Brust(i2c_port_t bus, uint8_t dev_addr, uint8_t reg_addr,
