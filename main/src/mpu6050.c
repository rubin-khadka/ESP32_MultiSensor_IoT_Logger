...
esp_err_t MPU6050_Init(void) {
	...
	if (I2C_Read_Reg(I2C_BUS_0, MPU6050_DEV_ADDR, MPU6050_WHO_AM_I,
					 &who_am_i) != ESP_OK) {
	...
	// Wake up MPU6050
	if (I2C_Write_Reg(I2C_BUS_0, MPU6050_DEV_ADDR, MPU6050_PWR_MGMT1, 0x00) !=
		ESP_OK) {
	...
	if (I2C_Write_Reg(I2C_BUS_0, MPU6050_DEV_ADDR, MPU6050_ACCEL_CONFIG,
					  0x00) != ESP_OK) {
	...
	// Configure Gyroscope
	if (I2C_Write_Reg(I2C_BUS_0, MPU6050_DEV_ADDR, MPU6050_GYRO_CONFIG, 0x00) !=
		ESP_OK) {
...
esp_err_t MPU6050_Read(MPU6050_Data_t *data) {
	...
	if (I2C_Read_Brust(I2C_BUS_0, MPU6050_DEV_ADDR, MPU6050_ACCEL_XOUT,
					   raw_data, 14) != ESP_OK) {
